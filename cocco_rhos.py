...
def main_algorithm(nc_file):
    ...
    Rrs_412 = geophysical_variables['rhos_412'][:]
    Rrs_443 = geophysical_variables['rhos_443'][:]
    Rrs_469 = geophysical_variables['rhos_469'][:]
    Rrs_488 = geophysical_variables['rhos_488'][:]
    Rrs_531 = geophysical_variables['rhos_531'][:]
    Rrs_547 = geophysical_variables['rhos_547'][:]
    Rrs_555 = geophysical_variables['rhos_555'][:]
    Rrs_645 = geophysical_variables['rhos_645'][:]
    Rrs_667 = geophysical_variables['rhos_667'][:]
    Rrs_678 = geophysical_variables['rhos_678'][:]
    Rrs_748 = geophysical_variables['rhos_748'][:]
    Rrs_859 = geophysical_variables['rhos_859'][:]
    # 对无效值进行掩膜
